...
BUCKET_POR_CIERRE = {
    "01. Traslado efectivo a CIS":                                   "DERIVACIÓN A DISPOSITIVO RED",
    "02. Traslado efectivo a DIPA":                                  "DERIVACIÓN A DISPOSITIVO RED",
    "03. Traslado efectivo a Micro":                                 "DERIVACIÓN A DISPOSITIVO RED",
    "05. Traslado efectivo a lugar de origen":                       "DERIVACIÓN A DISPOSITIVO RED",
    "06. Acepta CIS pero no hay vacante":                            "SE RETIRA VOLUNTARIAMENTE",
    "07. Se realiza entrevista y se retira del lugar":               "SE RETIRA VOLUNTARIAMENTE",
    "08. No se realiza entrevista y se retira del lugar":            "SE RETIRA VOLUNTARIAMENTE",
    "09. Derivación al equipo de Umbral Cero de Primer Abordaje":   "DERIVACION UMBRAL CERO",
    "12. Derivación a SAME por deterioro físico visible":            "DERIVACION A SAME",
    "13. Derivación a SAME por salud mental":                        "DERIVACION A SAME",
    "14. Derivación a Seguridad":                                    "DERIVACIÓN A SEGURIDAD Y A ORDENAMIENTO URBANO",
    "15. Derivación a Ordenamiento Urbano":                          "DERIVACIÓN A SEGURIDAD Y A ORDENAMIENTO URBANO",
    "16. No se observan personas y hay pertenencias":                "NO SE CONTACTA",
    "17. No se observan personas ni pertenencias":                   "NO SE CONTACTA",
    "18. Mendicidad":                                                "NO ERAN PSC",
    "19. Sin cubrir":                                                "SIN CUBRIR",
    "20. Desestimado":                                               "DESESTIMADO",
}
...
PATRONES_PERSONALIZADOS = {
    ...
    "dipa combate":                    "02. Traslado efectivo a DIPA",
    ...
    "ingreso micro":                   "03. Traslado efectivo a Micro",
    "traslados micro":                 "03. Traslado efectivo a Micro",
    "micro solidario":                 "03. Traslado efectivo a Micro",
    "se lo traslada a micro":          "03. Traslado efectivo a Micro",
    "se los traslada a micro":         "03. Traslado efectivo a Micro",
    ...
    "no se contacta y no se":          "17. No se observan personas ni pertenencias",
    "informa no se contacta":          "17. No se observan personas ni pertenencias",
    "no se contacta y se ob":          "16. No se observan personas y hay pertenencias",
    "se retira del lugar":             "07. Se realiza entrevista y se retira del lugar",
    "se retiran del lugar":            "07. Se realiza entrevista y se retira del lugar",
    "se retira":                       "07. Se realiza entrevista y se retira del lugar",
    "eximicion":                       "07. Se realiza entrevista y se retira del lugar",
    "asesoramiento":                   "07. Se realiza entrevista y se retira del lugar",
