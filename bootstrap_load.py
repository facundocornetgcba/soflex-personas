...
NOTA: La migración del Histórico Crudo está temporalmente deshabilitada.
      Solo se carga el Histórico Limpio (historico_limpio).
"""
...
def bootstrap():
    ...
    # 1. Migrar Histórico Crudo — TEMPORALMENTE DESHABILITADO
    # -----------------------------------------------------------------------
    ...
    print("📦 Iniciando migración de Histórico Limpio...")
    try:
